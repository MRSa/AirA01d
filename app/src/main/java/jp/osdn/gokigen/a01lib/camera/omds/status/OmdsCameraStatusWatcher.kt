...
class OmdsCameraStatusWatcher(private val opcEventReceiver: IOpcEventReceive? = null, userAgent: String = "OlympusCameraKit", private val executeUrl : String = "http://192.168.0.10") : ICameraStatusWatcher, ICameraStatus, IOmdsCommunicationInfo
{
