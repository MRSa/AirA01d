...
@Composable
fun ApplicationPreferencesButton(navController: NavHostController, viewModel: CameraStatusViewModel, modifier: Modifier = Modifier)
{
    val haptic = LocalHapticFeedback.current

    // ----- ステータスに合わせてアイコンをと色を決める
    val iconId = R.drawable.outline_settings_24
